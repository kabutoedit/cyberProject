    ...
    return (React.createElement("section", { className: styles.popularProducts },
        React.createElement("div", { className: 'container' },
            React.createElement("div", { className: styles.tags },
                React.createElement("button", { className: `${styles.tag} ${activeCategory === 'newArrival' ? styles.active : ''}`, onClick: () => setActiveCategory('newArrival') }, "New Arrival"),
                React.createElement("button", { className: `${styles.tag} ${activeCategory === 'bestseller' ? styles.active : ''}`, onClick: () => setActiveCategory('bestseller') }, "Bestseller"),
                React.createElement("button", { style: {
                        width: '159px',
                    }, className: `${styles.tag} ${activeCategory === 'featured' ? styles.active : ''}`, onClick: () => setActiveCategory('featured') }, "Featured Products")),
            React.createElement("div", { className: styles.products }, products[activeCategory].map(product => (React.createElement("div", { className: styles.product, key: product.id },
