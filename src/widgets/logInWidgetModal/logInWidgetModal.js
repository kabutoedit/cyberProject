...
// import { auth, LogIn } from '../../app/firebase/firebaseConfig'
...
// 				setSuccess(
// 					`Добро пожаловать, ${result.user.displayName || 'пользователь'}!`
// 				)
// 				setError('')
// 			})
// 			.catch(error => {
    ...
    return (React.createElement("div", { className: styles.modalWidget, onClick: e => e.stopPropagation() }, isModalOpen && (React.createElement("div", { className: styles.modalOverlay, onClick: e => {
        ...
        React.createElement("div", { className: styles.modalContent }, user ? (React.createElement(React.Fragment, null,
            React.createElement("h3", null,
                ...
                "!"),
            React.createElement("button", { onClick: closeModal, className: styles.closeButton }, "\u0417\u0430\u043A\u0440\u044B\u0442\u044C"),
            React.createElement("button", { onClick: LogOut, className: `${styles.closeButton} ${styles.logoutButton}` }, "\u0412\u044B\u0439\u0442\u0438"))) : (React.createElement(React.Fragment, null, error || success ? (React.createElement(React.Fragment, null,
