...
const DiscountProductsWidget = ({ productsData, }) => {
    ...
    return (React.createElement("section", { className: styles.discountProducts },
        React.createElement("div", { className: 'container' },
            ...
            React.createElement("div", { className: styles.products }, productsData.slice(20, 24).map((product, index) => (React.createElement(ProductCardWidget, { ...product, key: product.id ?? index, fillColors: fillColors[product.id] || {
                    fill: '#f6f6f6',
                    stroke: '#A8A8A8',
